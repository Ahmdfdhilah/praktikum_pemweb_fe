...
// Sample live preview component
const LivePreview = () => {
  return (
    <div className="bg-white p-4 border border-gray-300 rounded-lg">
      <div id="result" className="text-center">
        <h3 className="text-xl font-bold mb-2">Hello, JavaScript!</h3>
        <p>Ini adalah contoh output dari kode JavaScript yang Kalian buat.</p>
      ...
      >
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>Memahami konsep dasar JavaScript sebagai bahasa pemrograman web</li>
            <li>Menguasai penggunaan variabel, tipe data, dan operator dalam JavaScript</li>
            <li>Mengimplementasikan struktur kendali (conditionals dan loops)</li>
      ...
      >
        <div className="space-y-6">
          ...
          <div className="overflow-x-auto">
            <h3 className="text-lg font-semibold text-gray-800 my-4">Karakteristik Utama JavaScript</h3>
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Karakteristik</th>
                  <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Deskripsi</th>
                  <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Contoh</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Client-side scripting</td>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Berjalan di browser pengguna, tidak memerlukan kompilasi</td>
                  <td className="px-4 py-2"><code>document.getElementById('demo').innerHTML = 'Hello World';</code></td>
                </tr>
                <tr>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Dinamis</td>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Tipe data ditentukan saat runtime</td>
                  <td className="px-4 py-2"><code>let x = 5; // x adalah number<br />x = "John"; // sekarang x adalah string</code></td>
                </tr>
                <tr>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Berorientasi objek</td>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Berbasis prototipe alih-alih kelas</td>
                  <td className="px-4 py-2"><code>
                    <pre>{`
const person = {name: 'John', age: 30};
                ...
                <tr>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Event-driven</td>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Dapat merespons tindakan pengguna</td>
                  <td className="px-4 py-2"><code>
                    <pre>{`
...
`}</pre>
                ...
                <tr>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">First-class functions</td>
                  <td className="px-4 py-2 whitespace-nowrap font-medium">Fungsi dapat diperlakukan sebagai variabel</td>
                  <td className="px-4 py-2"><code>
                    <pre>{`
const greeting = function(name) { return \`Hello ${name}\`; };`}
          ...
          <div className="flex flex-col">
            <h3 className="text-lg font-semibold text-gray-800">Engine JavaScript</h3>
            <p>Engine JavaScript adalah program yang mengeksekusi kode JavaScript. Browser web modern memiliki engine JavaScript terintegrasi.</p>
          ...
          <div className="flex flex-col mt-6">
            <h3 className="text-lg font-semibold text-gray-800">Dasar-dasar JavaScript</h3>
            ...
            <div className="mt-4">
              ...
              <p>Number, String, Boolean, Undefined, Null, Symbol, dan BigInt</p>
            </div>
          </div>
          ...
          <div className='mt-4'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
              {[
                { title: "Server-side", tech: "Node.js, Deno", color: "bg-blue-50" },
                { title: "Mobile", tech: "React Native, Ionic", color: "bg-green-50" },
                { title: "Desktop", tech: "Electron, NW.js", color: "bg-yellow-50" },
                { title: "IoT", tech: "Johnny-Five, Cylon.js", color: "bg-purple-50" },
                { title: "Game", tech: "Phaser, Three.js", color: "bg-red-50" },
                { title: "AI/ML", tech: "TensorFlow.js, Brain.js", color: "bg-indigo-50" }
              ].map((item, index) => (
                <div key={index} className={`${item.color} p-4 rounded-xl shadow-md hover:scale-105 transition-transform`}>
                  <h4 className="font-semibold text-indigo-700 text-lg">{item.title}</h4>
          ...
          <div className='mt-12'>
            <div className="overflow-x-auto">
              <h3 className="text-lg font-semibold text-gray-800 my-4">Fitur JavaScript Modern</h3>
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Fitur</th>
                    <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Deskripsi</th>
                    <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Contoh</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Arrow Functions</td>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Sintaks ringkas untuk fungsi</td>
                    <td className="px-4 py-2"><code>
                      <pre>{`
const add = (a, b) => a + b;
`}</pre>
                  ...
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Template Literals</td>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">String yang mendukung interpolasi</td>
                    <td className="px-4 py-2"><code>
                      <pre>{`\`Hello, ${name}!\``}
                      </pre></code></td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Destructuring</td>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Ekstraksi nilai dari objek/array</td>
                    <td className="px-4 py-2"><code>
                      <pre>{`
const {name, age} = person;
                  ...
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Promises</td>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Penanganan operasi asinkron</td>
                    <td className="px-4 py-2"><code>
                      <pre>{`
...
`}</pre>
                  ...
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Async/Await</td>
                    <td className="px-4 py-2 whitespace-nowrap font-medium">Sintaks untuk kode asinkron</td>
                    <td className="px-4 py-2"><code>
                      <pre>{`
...
`}</pre>
          ...
          <div className="flex flex-col pt-4">
            <h3 className="text-lg font-semibold text-gray-800">Document Object Model (DOM)</h3>
            <p>DOM adalah representasi terstruktur dari dokumen HTML yang memungkinkan JavaScript untuk berinteraksi dengan dan memanipulasi konten halaman web.</p>
...
element.addEventListener('click', function() {
    alert('Element clicked!');
        ...
        `}</pre>
          ...
          <div className='mt-4'>
            <h3 className="text-lg font-semibold text-gray-800">Ekosistem JavaScript Modern</h3>
            <p className="text-lg font-medium text-gray-800">
              JavaScript modern tidak hanya terbatas pada browser, tetapi telah berkembang menjadi ekosistem lengkap untuk pengembangan berbagai platform:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mt-8">API Web Modern</h3>
            <p className="text-lg font-medium text-gray-800">
              JavaScript modern menawarkan berbagai API Web yang memungkinkan pengembangan aplikasi yang kaya fitur:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
              {[
                { title: "Fetch API", tech: "Mengirim permintaan jaringan", color: "bg-blue-50" },
                { title: "Web Storage", tech: "Menyimpan data di browser", color: "bg-green-50" },
                { title: "Geolocation", tech: "Mendapatkan lokasi pengguna", color: "bg-yellow-50" },
                { title: "Canvas", tech: "Menggambar grafik dinamis", color: "bg-purple-50" },
                { title: "WebSockets", tech: "Komunikasi dua arah real-time", color: "bg-red-50" },
                { title: "IndexedDB", tech: "Database di sisi klien", color: "bg-indigo-50" }
              ].map((item, index) => (
                <div key={index} className={`${item.color} p-4 rounded-xl shadow-md hover:scale-105 transition-transform`}>
                  <h4 className="font-semibold text-indigo-700 text-lg">{item.title}</h4>
                  <p className="text-sm text-gray-700 mt-1">{item.tech}</p>
      ...
      >
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <li>
              <strong>Code Editor</strong>: Visual Studio Code, Sublime Text, atau editor teks lainnya
            </li>
          </ul>

          <InfoBox type="tip" title="Rekomendasi">
            <p>
              Kami menyarankan menggunakan Visual Studio Code dengan ekstensi JavaScript (ES6)
              code snippets dan LiveServer untuk pengalaman pengembangan yang lebih baik.
            </p>
          </InfoBox>
        </div>
      </SectionWrapper>
          ...
          steps={[
            {
              ...
              content: (
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Buat sebuah file HTML baru dengan nama <code className="bg-gray-100 px-1 py-0.5 rounded">index.html</code> dan
                    file JavaScript dengan nama <code className="bg-gray-100 px-1 py-0.5 rounded">script.js</code>.
                    Hubungkan file JavaScript dengan file HTML menggunakan tag script.
                  </p>
...
<body>
    ...
    <script src="script.js"></script>
                  ...
                  <InfoBox type="info">
                    <p>
                      Tag <code className="bg-gray-100 px-1 py-0.5 rounded">script</code> dapat diletakkan di dalam{' '}
                      <code className="bg-gray-100 px-1 py-0.5 rounded">head</code> atau sebelum penutup{' '}
                      <code className="bg-gray-100 px-1 py-0.5 rounded">body</code>. Menempatkannya sebelum penutup body memastikan
                      bahwa semua elemen HTML telah dimuat sebelum JavaScript dijalankan.
                    </p>
                  </InfoBox>
                </div>
              )
            },
            {
              ...
              content: (
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Buka file <code className="bg-gray-100 px-1 py-0.5 rounded">script.js</code> dan
                    tulis kode berikut untuk mendeklarasikan variabel dan menampilkan output:
                  </p>
...
\`;`}
                  ...
                  <p className="text-gray-700">
                    Buka file HTML Kalian di browser dan buka konsol pengembang (F12 atau klik kanan → Inspect → Console)
                    untuk melihat output yang dihasilkan.
                  </p>

                  <InfoBox type="tip">
                    <p>
                      Template literals (menggunakan backticks ``) memungkinkan Kalian untuk menyisipkan variabel
                      langsung ke dalam string dengan menggunakan sintaks <code className="bg-gray-100 px-1 py-0.5 rounded">${'{'}variabel{'}'}</code>.
                    </p>
                  </InfoBox>
                </div>
              )
...
\`;`}
                  ...
                  <InfoBox type="info">
                    <p>
                      JavaScript menyediakan beberapa cara untuk membuat keputusan berdasarkan kondisi:
                      if-else, ternary operator (?:), dan switch-case. Pilih yang paling sesuai
                      dengan kebutuhan kode Kalian.
                    </p>
                  </InfoBox>
                </div>
              )
...
for (let nilai of nilaiSiswa) {
    ...
    \`;
                  ...
                  <InfoBox type="info">
                    <p>
                      JavaScript menyediakan beberapa jenis loop: for, while, do-while, for...in, dan for...of.
                      for...of (diperkenalkan di ES6) sangat berguna untuk meng-iterasi array dan objek iterable lainnya.
                    </p>
                  </InfoBox>
                </div>
              )
...
<div class="event-demo p-4 my-4 border border-gray-300 rounded">
    ...
    <div class="mt-4">
        ...
        <div id="hasil-kalkulator" class="mt-3 font-semibold"></div>
                  ...
                  <InfoBox type="info">
                    <p>
                      Array dan objek adalah struktur data penting dalam JavaScript. Array digunakan untuk menyimpan koleksi data,
                      sedangkan objek digunakan untuk menyimpan data dalam bentuk pasangan key-value. JavaScript menyediakan banyak
                      metode bawaan untuk memanipulasi array dan objek.
                    </p>
                  </InfoBox>

                  <ResultPreview title="Output Langkah 8" livePreview={<LivePreview />} >
...
document.getElementById("btn-ubah-warna").addEventListener("click", function() {
  ...
  domOutput.className = \`p-4 mb-3 \${randomColor} rounded\`;
                  ...
                  <InfoBox type="info">
                    <p>
                      DOM adalah representasi struktur HTML dalam bentuk pohon objek. JavaScript dapat memanipulasi DOM untuk
                      mengubah konten, struktur, dan gaya halaman web secara dinamis.
                    </p>
                  </InfoBox>

                  <ResultPreview title="Output Langkah 8" imageSrc='/api/placeholder/600/300'>
                    {/* <img src="/api/placeholder/600/300" alt="Demo manipulasi DOM" className="border border-gray-300 rounded" /> */}
                  </ResultPreview>
                </div>
              )
            },
...
document.getElementById("btn-fetch").addEventListener("click", async function() {
  try {
    ...
    \`;
                  ...
                  <InfoBox type="info">
                    <p>
                      Fetch API adalah cara modern untuk melakukan HTTP request di JavaScript. Dengan async/await,
                      kode menjadi lebih mudah dibaca dan dikelola dibandingkan dengan callback atau promise chaining.
                    </p>
                  </InfoBox>

                  <ResultPreview title="Output Langkah 8" imageSrc='/api/placeholder/600/300'>
                    {/* <img src="/api/placeholder/600/300" alt="Demo Fetch API" className="border border-gray-300 rounded" /> */}
                  </ResultPreview>
                </div>
              )
            }]}
      ...
      >
        <div className="space-y-4">
          ...
          <ResultPreview title="Hasil Akhir Praktikum" livePreview={<LivePreview />}>
          </ResultPreview>
        </div>
      </SectionWrapper>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Tugas:</h3>
              <ol className="pl-6 space-y-2 text-gray-700 list-decimal">
                <li>
                  Buatlah aplikasi to-do list sederhana. Style tampilan tidak menjadi penilaian, fokus utama pada fungsionalitas JavaScript, dengan kriteria:
                ...
                <li>
                  Modifikasi kalkulator pada langkah 5 untuk mendukung operasi matematika tambahan seperti
                  pangkat, akar kuadrat, dan modulus.
                </li>
                <li>
                  Buatlah sebuah fungsi untuk memvalidasi form input dengan kriteria:
                  <ul className="list-disc pl-6 mt-2 space-y-2">
          ...
          <SubmissionLink
            href="https://example.com/submit-praktikum"
          >
          </SubmissionLink>
        </div>
      </SectionWrapper>
